...
def generate_vpn_keys(directory: str):
...
def generate_additional_vpn_keys(directory: str, name: str):
	path = os.path.join(directory, 'pki')
...
def format_vpn_keys(directory: str) -> str:
	included_files = {
...
def format_vpn_server_keys(directory: str) -> str:
	included_files = {
		'ca': directory + '/pki/ca.crt',
