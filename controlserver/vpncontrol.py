...
class VPNControl:
	...
	def ban_team(self, team_id: int, until_tick: Optional[int]):
		if not team_id:
			return
		if until_tick == 0:
			until_tick = None
